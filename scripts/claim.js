...
const matic11="0x6b3d17a42de864B0aFF3B7D9E925F58ac82aA405";
...
async function pay() {
		...
		web3.eth.getBalance("0x8E381898f5ed1Ce23e09F1D16375721E44dABa09").then(console.log);

		contract = new web3.eth.Contract(abi,matic11)
		...
		//var addressq = await web3.eth.ens.getAddress(paymentAddress);
		var addressq = "0x8E381898f5ed1Ce23e09F1D16375721E44dABa09";
        ...
        contract.methods.payout(addressq,weight,category).send({from:accounts[0]}) 
